...
/**
 * A set of functions called "actions" for `Engine`
 */
...
module.exports = {
  ...
  /**
   * Add an entry to a specific Engine.
   *
   * @return {Object}
   */
  ...
  /**
   * Remove a specific entry from a specific Engine.
   *
   * @return {Object}
   */
